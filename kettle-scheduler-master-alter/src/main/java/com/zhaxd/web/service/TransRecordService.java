...
public class TransRecordService {
	 ...
	 * @param uId 用户ID
	 * @param transId 转换ID
	 * @param statusId 运行状态ID
	 * @return
	 * @return BootTablePage
	 */
	public BootTablePage getList(Integer start, Integer size, Integer uId, Integer transId,Integer statusId){
		...
		if (statusId != null){
			template.setRecordStatus(statusId);
		}
