...
public class TransRecordController {
	...
	public String getList(Integer offset, Integer limit, Integer transId,Integer statusId, HttpServletRequest request){
		KUser kUser = (KUser) request.getSession().getAttribute(Constant.SESSION_ID);
		BootTablePage list = transRecordService.getList(offset, limit, kUser.getuId(), transId, statusId);
