...
public class JobRecordController {
	...
	public String getList(Integer offset, Integer limit, Integer jobId,Integer statusId, HttpServletRequest request){
		KUser kUser = (KUser) request.getSession().getAttribute(Constant.SESSION_ID);
		BootTablePage list = jobRecordService.getList(offset, limit, kUser.getuId(), jobId,statusId);
