...
<div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="col-sm-7">
                    <div class="form-inline text-right">
                        <div class="form-group">
                            ...
                            <select id="statusId" class="form-control m-b-xs" >
                                <option value="">请选择转换状态</option>
  ...
  data-url="trans/record/$(statusId ).shtml"
            --%>
...
<script>
    ...
    function queryParams(params) {
        ...
        var temp = {limit: 10, offset: params.offset, transId: $transId, statusId: $statusId};
        return temp;
    };
